...
class ClaimsReportStatus(str, enum.Enum):
    DRAFT = "DRAFT"
    FINAL = "FINAL"


class ClaimsRowLinkageType(str, enum.Enum):
    LINKED = "LINKED"
    MANUAL = "MANUAL"


class ClaimsCategory(str, enum.Enum):
...
class ClaimsReportCaseStatus(str, enum.Enum):
    OPEN = "OPEN"
    CLOSED = "CLOSED"
...
class ClaimsFinalOutcomeType(str, enum.Enum):
